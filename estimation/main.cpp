...
//           cout << "Status: " << resMasterSolver.getStatus() << endl;
//           cout <<" Objective : " << resMasterSolver.getObjValue() << endl;
//           for(i = 0; i < lamda.getSize(); i++)
//           {
//               cout << "Lamda[" << i << "] = " << resMasterSolver.getValue(lamda[i]) << endl;
//           }

//           for(i = 0; i < pE.getSize(); i++)
//           {
//               cout << "pE[" << i << "] = " << resMasterSolver.getValue(pE[i]) << ", nE[" << i << "] = " << resMasterSolver.getValue(nE[i]) << endl;
//           }
